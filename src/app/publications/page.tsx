...
const publications = [
  {
    ...
    venue: "CHI '24",
    year: 2024,
    abstract: "We present Intelligent Canvas, a design tool that learns from user behavior to provide contextual suggestions and automate repetitive tasks. Through a 4-week deployment study with 12 professional designers, we demonstrate a 40% reduction in time spent on repetitive tasks while maintaining design quality.",
    pdf: "#",
  ...
  },
  {
    ...
    venue: "UIST '23",
    year: 2023,
    abstract: "We introduce a novel approach to real-time collaborative coding that uses machine learning to predict and prevent merge conflicts. Our system reduces conflicts by 75% compared to traditional operational transformation approaches.",
    pdf: "#",
  ...
  },
  {
    ...
    venue: "CHI '23",
    year: 2023,
    abstract: "Through participatory design sessions with 20 novice and expert 3D modelers, we developed a gesture vocabulary for 3D modeling that achieves 95% recognition accuracy and reduces learning time by 3x compared to traditional interfaces.",
    pdf: "#",
  ...
  },
  {
    ...
    venue: "ACM TOCHI",
    year: 2022,
    abstract: "A comprehensive survey and novel framework for conflict resolution in distributed collaborative editing systems. We present a taxonomy of conflict types and evaluate existing approaches across multiple dimensions.",
    pdf: "#",
  ...
  },
  {
    ...
    venue: "VIS '21",
    year: 2021,
    abstract: "We present a unified framework for visualizing and explaining deep learning model predictions, integrating SHAP values, attention mechanisms, and counterfactual explanations in a single interactive interface.",
    pdf: "#",
  ...
  },
  {
    ...
    year: 2021,
    abstract: "A position paper exploring the challenges of building design tools that prioritize accessibility from the ground up, based on interviews with 15 designers and developers.",
    pdf: "#",
  },
];
...
const blogPosts = [
  {
    ...
    date: "March 2024",
    excerpt: "Reflections on what I've learned about designing AI-powered tools that actually help users rather than get in their way.",
  },
  {
    id: 2,
    title: "The State of Real-Time Collaboration in 2023",
    date: "December 2023",
    excerpt: "A technical deep-dive into modern approaches to building collaborative applications, from CRDTs to operational transformation.",
  },
  {
    id: 3,
    title: "Why Gesture Interfaces Haven't Taken Off (And How We Can Fix That)",
    date: "June 2023",
    excerpt: "An analysis of the challenges facing gesture-based interfaces and potential solutions based on recent research.",
  },
];
